...
//它是一个对象；在 这个 module 对象身上，有个 rules 属性，这个 rules 属性是个 数组；这个数组中，存放了，所有第三方文件的 匹配和 处理规则；
...
// 二,根据物理html模块中的文件自动生成内存中的html文件的插件
// 1,安装 npm i html-webpack-plugin -D
// 2,在package.json中导入该插件 const htmlWebpackPlugin=require('html-webpack-plugin')